...
in_game_regions_map: dict[str, tuple[str]] = {
    ...
    "Wildlife Exploitation Preserve": ("Natural Selection Annex",),
    "Natural Selection Annex": tuple(),
    "Opportunity": tuple(),
    ...
    "The Dust": ("Lynchwood", "Friendship Gulag", "Eridium Blight", "The Highlands", "Three Horns Valley"),
    "Lynchwood": tuple(),
