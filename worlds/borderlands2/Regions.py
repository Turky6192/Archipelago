...
in_game_regions_map: dict[str, tuple[str]] = {
    ...
    "Three Horns Divide": ("Frostburn Canyon", "Three Horns Valley", "Tundra Express", "Sanctuary", "Sanctuary Hole"),
    "Frostburn Canyon": tuple(),
    "Sanctuary": tuple(),
    "Sanctuary Hole": ("Caustic Caverns",),
    "Caustic Caverns": tuple(),
    "Three Horns Valley": ("Southpaw Steam and Power", "Bloodshot Stronghold", "The Fridge", "The Dust"),
    "Southpaw Steam and Power": tuple(),
    "Bloodshot Stronghold": ("Bloodshot Ramparts",),
    "Bloodshot Ramparts": tuple(),
    "The Fridge": ("Fink's Slaughterhouse", "Highlands Outwash"),
    "Fink's Slaughterhouse": tuple(),
    "Highlands Outwash": ("The Highlands",),
    "The Highlands": ("Wildlike Exploitation Preserve", "Opportunity", "The Holy Spirits", "Thousand Cuts", "The Dust"),
    "Wildlike Exploitation Preserve": tuple(),
    "Opportunity": tuple(),
    "The Holy Spirits": tuple(),
    "Thousand Cuts": ("Terramorphous Peak", "The Bunker"),
    "Terramorphous Peak": tuple(),
    "The Bunker": ("Control Core Angel",),
    "Control Core Angel": tuple(),
    "Tundra Express": ("End of the Line",),
    "End of the Line": tuple(),
    "The Dust": ("Lynchwood", "Friendship Gulag", "Eridium Blight"),
    "Lynchwood": tuple(),
    "Friendship Gulag": tuple(),
    "Eridium Blight": ("Ore Chasm", "Sawtooth Cauldron", "Arid Nexus Boneyard", "Hero's Pass"),
    "Ore Chasm": tuple(),
    "Sawtooth Cauldron": tuple(),
    "Arid Nexus Boneyard": ("Arid Nexus Badlands",),
    "Arid Nexus Badlands": tuple(),
